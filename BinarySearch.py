#이진 검색 트리 클래스 BinarySearchTree사용

from enum import Enum
from bst import BinarySearchTree


Menu =Enum('Menu',['삽입','삭제','검색','덤프','키의 범위','종료'])
...
tree = BinarySearchTree() #이진검색트리생성
...
while True:
    ...
    elif menu == Menu.키의범위: #키의 범위 최솟값과 최대값
